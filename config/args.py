...
class Args(TypedArgs):
    model: str = add_argument("--model", default="aae")
    ...
    rows: int = add_argument("--row", default=28, help="The number of rows in optimization region")
    columns: int = add_argument("--column", default=28, help="The number of column in optimization region")
